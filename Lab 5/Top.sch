...
<drawing version="7">
    ...
    <netlist>
        ...
        <blockdef name="statemachine">
            <timestamp>2016-2-9T6:53:31</timestamp>
        ...
        <blockdef name="ff5">
            <timestamp>2016-2-9T7:1:47</timestamp>
            <rect width="256" x="64" y="-128" height="128" />
            <line x2="0" y1="-96" y2="-96" x1="64" />
            <rect width="64" x="0" y="-44" height="24" />
            <line x2="0" y1="-32" y2="-32" x1="64" />
        ...
        <block symbolname="ff5" name="XLXI_3">
            <blockpin signalname="clk" name="clk" />
            <blockpin signalname="NS(4:0)" name="D(4:0)" />
            <blockpin signalname="PS(4:0)" name="Q(4:0)" />
        </block>
        ...
        <block symbolname="statemachine" name="XLXI_220">
            <blockpin signalname="XLXN_65" name="GO" />
            <blockpin signalname="XLXN_66" name="ANSWER" />
            <blockpin signalname="FourSecs" name="FourSecs" />
            <blockpin signalname="Correct" name="Correct" />
            <blockpin signalname="PS(4:0)" name="PS(4:0)" />
            <blockpin signalname="RightInc" name="RightInc" />
            <blockpin signalname="WrongInc" name="WrongInc" />
            <blockpin signalname="ResetTime" name="ResetTime" />
            <blockpin signalname="RunLFSR" name="RunLFSR" />
            <blockpin signalname="ShowNums" name="ShowNums" />
            <blockpin signalname="FlashRight" name="FlashRight" />
            <blockpin signalname="FlashWrong" name="FlashWrong" />
            <blockpin signalname="ShowStats" name="ShowStats" />
            <blockpin signalname="NS(4:0)" name="NS(4:0)" />
        </block>
